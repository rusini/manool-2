...
int main() {
   ...
   auto p_int  = opt::proc::make    ({123, 0}); // Integer datatype
   auto p_bool = opt::rel_base::make({456, 0}); // Boolean datatype
   auto p_oops = opt::rel_base::make({999, 0}); // signaling exceptions
   ...
   auto p_fact = opt::proc::make({1, 0}); // iterative version of Factorial
   {  auto p = p_fact;
